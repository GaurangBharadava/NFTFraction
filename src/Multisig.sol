...
contract MultiSigWallet {
    ...
    error NotEnoughApprovals(); // @audit-info unused error // e solved
    ...
    // @audit-info after execution of the transaction the transaction should be deleted from the array.
